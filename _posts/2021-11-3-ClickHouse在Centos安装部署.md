---
layout: post
title: ClickHouse 基本特性及在Centos 安装部署
categories: ClickHouse
description: ClickHouse 基本特性及在Centos 安装部署
keywords: ClickHouse 安装

---

# ClickHouse在Centos安装部署
...
如果想使用最新的版本，请用`testing`替代`stable`(推荐用于测试环境)。`prestable`有时也可用。
